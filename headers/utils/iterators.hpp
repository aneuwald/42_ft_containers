...
/*   Updated: 2022/03/29 14:08:13 by acanterg         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
public:
    ...
    normal_iterator &operator=(const normal_iterator<T> &rawIterator) { _m_current = rawIterator._m_current; return (*this); };

    normal_iterator &operator=(T *ptr) { _m_current = ptr; return (*this); }
    ...
    normal_iterator &operator+=(const difference_type &n) { _m_current += n; return (*this); }
    normal_iterator &operator-=(const difference_type &n) { _m_current -= n; return (*this); }
